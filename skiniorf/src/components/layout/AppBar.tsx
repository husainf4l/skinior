...
const AppBar: React.FC<AppBarProps> = ({
  ...
  return (
    <>
      ...
      />
      <Animated.View style={[styles.appBar, animatedStyle]} pointerEvents="auto">
        <View style={styles.appBarContent} pointerEvents="auto">
          <TouchableOpacity
            style={[styles.iconButton, { backgroundColor: 'rgba(255,0,0,0.3)', zIndex: 1000 }]} // Temporary red background for debugging
            onPress={() => {
