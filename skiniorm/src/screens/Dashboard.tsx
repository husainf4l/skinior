...
const Dashboard: React.FC<DashboardProps> = ({ navigation }) => {
  ...
  const handleLogout = async () => {
    ...
    Alert.alert('Logout', 'You would be redirected to login screen');
  };
    ...
    >
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.profileButton} onPress={() => {}}>
            <View style={styles.avatarContainer}>
              <Text style={[styles.iconText, { color: colors.accent, fontSize: 32 }]}>
                {getIconText('account-circle')}
              </Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.analysisCard}>
          <View style={styles.cardHeader}>
            <View style={styles.cardHeaderLeft}>
              <Text style={[styles.iconText, { color: colors.accent, fontSize: 20 }]}>
                {getIconText('brain')}
              </Text>
        ...
        <View style={styles.routineCard}>
          <View style={styles.cardHeader}>
            <View style={styles.cardHeaderLeft}>
              <Text style={[styles.iconText, { color: colors.success, fontSize: 20 }]}>
                {getIconText('clock-outline')}
              </Text>
            ...
            {todayRoutine.map(step => (
              ...
              >
                <View style={styles.stepLeft}>
                  ...
                  >
                    {step.completed && (
                      <Text style={[styles.iconText, { color: '#FFFFFF', fontSize: 12 }]}>
                        {getIconText('check')}
                      </Text>
                    )}
                  </View>
                ...
                >
                  {getIconText(step.timeOfDay === 'morning' ? 'weather-sunny' : 'moon-waning-crescent')}
                </Text>
              </TouchableOpacity>
            ))}
          </View>
        ...
        <View style={styles.actionsContainer}>
          ...
          <View style={styles.actionsGrid}>
            <TouchableOpacity
              ...
              onPress={() => Alert.alert('AI Consultant', 'AI Chat feature coming soon!')}
            >
              <View
                style={[
                  styles.actionIcon,
              ...
              >
                <Text style={[styles.iconText, { color: colors.accent, fontSize: 24 }]}>
                  {getIconText('brain')}
                </Text>
              </View>
            ...
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => Alert.alert('Skin Scan', 'Skin scan feature coming soon!')}
            >
              <View
                style={[
                  styles.actionIcon,
              ...
              >
                <Text style={[styles.iconText, { color: colors.success, fontSize: 24 }]}>
                  {getIconText('camera')}
                </Text>
              </View>
            ...
            <TouchableOpacity style={styles.actionCard}>
              ...
              >
                <Text style={[styles.iconText, { color: colors.warning, fontSize: 24 }]}>
                  {getIconText('chart-line-variant')}
                </Text>
              </View>
            ...
            <TouchableOpacity style={styles.actionCard}>
              ...
              >
                <Text style={[styles.iconText, { color: colors.primary, fontSize: 24 }]}>
                  {getIconText('sparkles')}
                </Text>
              </View>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
      >
        <Text style={[styles.iconText, { color: '#FFFFFF', fontSize: 24 }]}>
          ⚙️
        </Text>
      </TouchableOpacity>
    </MainLayout>
