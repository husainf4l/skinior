/**
 * Cross-platform AppBar Component with Modern Design
 *
 * Features:
 ...
 *     { icon: 'account', onPress: handleProfile, badge: 2 }
 *   ]}
 * />
 */
...
// Icon mapping from SFSymbol to MaterialCommunityIcons
const iconMap: { [key: string]: string } = {
  ...
  'chart.line.uptrend.xyaxis': 'chart-line-variant',
  'sparkles': 'sparkles',
  'house': 'home',
