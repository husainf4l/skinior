...
export class OpenCVProcessor {
  ...
  public setFaceDetectionCallback(callback: (detected: boolean, quality: number) => void) {
    ...
    return new Promise((resolve) => {
      ...
      setTimeout(() => {
        resolve({
          ...
          texture: { score: 88, description: 'Good texture with minor roughness' },
          hydration: { score: 75, description: 'Moderately hydrated, could improve' },
